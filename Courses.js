...
C is a general-purpose programming language known for its efficiency and low-level control over hardware. It was developed in the early 1970s by Dennis Ritchie and is widely used for system programming and developing applications in various domains.</p>
            </div>
          </div>
        </div>
        ...
        <div className="col">
          <div className="card">
            ...
            <div className="card-body">
              ...
              <p className="card-text">JavaScript is a versatile programming language used for creating interactive and dynamic web content. With its wide range of libraries and frameworks, JavaScript empowers developers to build powerful applications that run seamlessly across different platforms.</p>
            </div>
          </div>
        </div>
      </div>
